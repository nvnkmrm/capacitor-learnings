export interface CapacitorConfig {
  ...
  android?: {
     ...
     *
     * [Mixed
     * content](https://developer.mozilla.org/en//US/docs/Web/Security/Mixed//content)
  ...
  server?: {
    ...
    // Web APIs that would otherwise require a [secure \* context](https://developer.mozilla.org/en//US/docs/Web/Security/Secure//Contexts)
    // such as
